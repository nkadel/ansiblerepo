...
%if %{with tests}
BuildRequires: python3-%{python3_pkgversion}-pytest
BuildRequires: python3-%{python3_pkgversion}-pyyaml
BuildRequires: python3-%{python3_pkgversion}-packaging
BuildRequires: python3-%{python3_pkgversion}-pip
BuildRequires: python3-%{python3_pkgversion}-setuptools
BuildRequires: python3-%{python3_pkgversion}-toml
BuildRequires: python3-%{python3_pkgversion}-tox-current-env >= 0.0.6
BuildRequires: python3-%{python3_pkgversion}-wheel
%endif
