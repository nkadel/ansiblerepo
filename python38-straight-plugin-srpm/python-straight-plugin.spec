...
%package -n     python%{python3_pkgversion}-straight-plugin
Summary:        Python plugin loader

%description -n python%{python3_pkgversion}-straight-plugin
straight.plugin is a Python plugin loader inspired by twisted.plugin with two
important distinctions:
...
%files -n python%{python3_pkgversion}-straight-plugin
