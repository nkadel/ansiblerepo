...
%package -n python%{python3_pkgversion}-argcomplete
Summary:        %{summary}
%description -n python%{python3_pkgversion}-argcomplete %_description
...
%files -n python%{python3_pkgversion}-argcomplete
%license LICENSE.rst
%doc README.rst
