...
# This means version 0.2.7:
%global hash 5f8ccce2f70b3a5d27c47ce19fe33e5bdd815571
...
# Workaround for python3.12 craziness
#%if 0%{?el8} || 0%{?el9}
#ln -sf %{_includedir}/python%{python3_pkgversion}/cpython/longintrepr.h .
#%endif
...
cythonize-%{python3_pkgversion} ruamel.yaml.clib/*.pyx
mv ruamel.yaml.clib/* .
...
%changelog
* Tue Oct 10 2023 Jason Montleon <jmontleo@redhat.com> - 0.2.8-1
- Update to 0.2.8

* Tue Jul 18 2023 Jason Montleon <jmontleo@redhat.com> - 0.2.7-1
- Update to 0.2.7
